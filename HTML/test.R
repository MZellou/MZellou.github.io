      ...
      <div class="timeline__box">
        ...
        <div class="timeline__post">
          <div class="timeline__content">
            <p>Attends the Philadelphia Museum School of Industrial Art. Studies design with Alexey Brodovitch, art director at Harpers Bazaar, and works as his assistant.</p>
          </div>
        </div>
      </div>
      <div class="timeline__box">
...
<div class="linkedin">
  <div class="linkedin__container">
    <p class="linkedin__text">Im looking for my fans which Ill give away everything I know. If youre interested then <a href="https://www.patreon.com/melnik909" class="linkedin__link" rel="noopener noreferrer" target="_blank">join to me on Patreon!</a></p>
  </div>
</div>'