  ...
  <div class="timeline">
    ...
    <div class="timeline__group">
      ...
      <div class="timeline__box">
        ...
        <div class="timeline__post">
          <div class="timeline__content">
            <p><b>Projet spécifique de recherche au sein du Laboratoire d\'Ingéniérie Circulation Transport (LICIT): Lyon, France (Java): </b>
            ...
            aériennes. Pour plus d\'informations : <a href="https://mocopo.ifsttar.fr/">visitez le site de MOCoPo</a>  </li>
          </div>
        </div>
      </div>
      <div class="timeline__box">
