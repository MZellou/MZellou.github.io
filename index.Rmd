...
HTML(" Chef de projets intormatiques <br> Ministère de la Transition Écologique et Solidaire ")
HTML("<br>")
...
dataBasic <- data.frame(
  ...
  end = c("2016-09-01", "2017-10-01", "2018-09-01", "2018-09-01", "2020-10-01", "2020-10-01")
)
 config <- list(
      editable = F,
      align = "center",
